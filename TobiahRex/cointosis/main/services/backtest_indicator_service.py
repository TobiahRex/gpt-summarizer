...
class IndicatorsService:
    ...
    def calculate_indicators(self, indicator_value_map, price_df, context):
        for name, params in indicator_value_map.items():
            ...
            if name == 'states':
                price_df = self._calc_states(price_df, context.get('tf'))
            if name == 'force':
                price_df = self._calc_force(price_df, context.get('symbol'))
        return price_df
    ...
    def _calc_states(self, price_df, agg: str):
        """
